...
const PlaceItem = (props) => {
  ...
  const showDeleteWarningHandler = () => setShowConfModal(true);

  const cancelDeleteHandler = () => setShowConfModal(false);
  ...
  return (
    <React.Fragment>
      ...
      <Modal header="Are you sure?"
        ...
        <p>Do you want to proceed and delete this place? Please note that can't be undone trereafter.</p>
      </Modal>
